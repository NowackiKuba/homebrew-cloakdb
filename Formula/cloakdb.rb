class Cloakdb < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/NowackiKuba/cloakdb-api/releases/download/v0.1.0/cloakdb-darwin-arm64.tar.gz"
      sha256 "PLACEHOLDER_ARM64"
    else
      url "https://github.com/NowackiKuba/cloakdb-api/releases/download/v0.1.0/cloakdb-darwin-amd64.tar.gz"
      sha256 "PLACEHOLDER_AMD64"
    end
  end

  on_linux do
    url "https://github.com/NowackiKuba/cloakdb-api/releases/download/v0.1.0/cloakdb-linux-amd64.tar.gz"
